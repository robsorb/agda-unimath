...
<pre class="Agda"><a id="24" class="Keyword">module</a> <a id="31" href="modal-type-theory.crisp-types.html" class="Module">modal-type-theory.crisp-types</a> <a id="61" class="Keyword">where</a>
</pre>
## Idea
