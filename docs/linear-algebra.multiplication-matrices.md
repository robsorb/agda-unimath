...
<pre class="Agda"><a id="39" class="Keyword">module</a> <a id="46" href="linear-algebra.multiplication-matrices.html" class="Module">linear-algebra.multiplication-matrices</a> <a id="85" class="Keyword">where</a>
</pre>
...
<pre class="Agda"><a id="214" class="Comment">{-
...
<pre class="Agda"><a id="933" class="Comment">{-
mul-transpose :
...
<pre class="Agda"><a id="1454" class="Comment">{-
module _
  {l : Level}
  {K : UU l}
  {addK : K → K → K}
...
<a id="5189" class="Comment">{- TODO: right distributivity
